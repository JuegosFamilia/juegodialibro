...
const respuestasCorrectas = ["VIOLÍN"]; // Aquí puedes agregar más respuestas correctas
const verificarRespuestas = () => {
  ...
  if (respuestasCorrectas.includes(respuesta1)) {
    ...
    document.getElementById("imagen").src = "img/jirafa.jpeg"; // Aquí debes colocar la URL de tu imagen
  } else {
