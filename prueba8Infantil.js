...
const respuestasCorrectas = ["GRAN", "CACA", "FRESCA"]; // Aquí puedes agregar más respuestas correctas
const verificarRespuestas = () => {
  ...
  if (respuestasCorrectas.includes(respuesta1) && respuestasCorrectas.includes(respuesta2) && respuestasCorrectas.includes(respuesta3)) {
    ...
    document.getElementById("imagen").src = "img/pañal.jpeg"; // Aquí debes colocar la URL de tu imagen
  } else {
