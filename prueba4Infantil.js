const respuestasCorrectas = ["ESTABA", "HELADA", "DE", "FRÍO"]; // Aquí puedes agregar más respuestas correctas
    const verificarRespuestas = () => {
      ...
      if (respuestasCorrectas.includes(respuesta1) && respuestasCorrectas.includes(respuesta2) && respuestasCorrectas.includes(respuesta3) && respuestasCorrectas.includes(respuesta4)) {
        ...
        document.getElementById("imagen").src = "img/ovejita.jpeg"; // Aquí debes colocar la URL de tu imagen
      } else {
